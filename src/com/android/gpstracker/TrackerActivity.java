...
import com.android.gpstracker.data.DateUtils;
import com.android.gpstracker.data.TrackerDataHelper;
import com.android.gpstracker.data.TrackerListHelper;
...
public class TrackerActivity extends ListActivity {
    ...
    static final String LOG_TAG = "gpstracker";
    ...
    private String getUniqueFileName(String ext) {
        File dir = new File("/sdcard/gpstracker");
        if (!dir.exists()) {
            dir.mkdir();
        }
        return "/sdcard/gpstracker/tracking-" +
